    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className={`hidden lg:flex items-center space-x-8 text-xs tracking-[0.22em] uppercase font-sans font-semibold transition-colors duration-300 ${isDarkBg ? 'text-white' : 'text-[#141416]'
            }`}>
            <a
              href="#collection"
            ...
            >
              ...
              <span className={`absolute bottom-0 left-0 w-0 h-[1.5px] transition-all duration-300 group-hover:w-full ${isDarkBg ? 'bg-[#DFC27D]' : 'bg-[#C5A059]'
                }`}></span>
            </a>
            <a
              href="#jazeera"
            ...
            >
              <Plane className={`w-3.5 h-3.5 transition-colors ${isDarkBg ? 'text-[#DFC27D]' : 'text-[#87692A]'
                }`} />
              <span>Jazeera Edition</span>
              <span className={`w-1.5 h-1.5 rounded-full ${isDarkBg ? 'bg-[#DFC27D]' : 'bg-[#6A0D18]'
                }`}></span>
            </a>
          </div>
          ...
          <a href="#" className="flex items-center space-x-3 text-center group py-2">
            ...
            <div className="flex flex-col text-left">
              <div className="flex items-baseline space-x-1.5">
                <span className={`font-serif text-lg sm:text-xl font-bold tracking-[0.25em] uppercase transition-colors duration-300 ${isDarkBg ? 'text-white' : 'text-[#141416]'
                  }`}>
                  TREPPAN
                </span>
                <span className={`font-serif text-xs sm:text-sm font-semibold pl-1.5 border-l transition-colors duration-300 ${isDarkBg ? 'text-[#DFC27D] border-white/20' : 'text-[#87692A] border-[#C5A059]/40'
                  }`}>
                  53
                </span>
              </div>
              <span className={`text-[7.5px] sm:text-[8.5px] uppercase tracking-[0.45em] font-medium transition-colors duration-300 ${isDarkBg ? 'text-white/70' : 'text-[#737380]'
                }`}>
          ...
          {/* Right: VIP Concierge Enquiry & Mobile Toggle */}
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className={`lg:hidden backdrop-blur-xl border-b px-6 py-6 space-y-4 shadow-2xl animate-fadeIn ${isDarkBg
          ...
          <div className="flex flex-col space-y-3 text-xs tracking-[0.22em] uppercase font-sans font-semibold">
            ...
            >
              ...
              <span className={`w-2 h-2 rounded-full ${isDarkBg ? 'bg-[#DFC27D]' : 'bg-[#6A0D18]'
                }`}></span>
            </a>
          </div>
        </div>
